...
public class AttributeRegistry {
    ...
    public static final RegistryObject<Attribute> FIRE_REACTION_UP = REACTION_ATTRIBUTES.register("fire_reaction_up", () -> new TypedRangedAttribute("elemental:fire_reaction_up", 0.0D, 0.0D, 1024D, FIRE_DAMAGE).setSyncable(true));
    public static final RegistryObject<Attribute> COLD_REACTION_UP = REACTION_ATTRIBUTES.register("cold_reaction_up", () -> new TypedRangedAttribute("elemental:cold_reaction_up", 0.0D, 0.0D, 1024D, COLD_DAMAGE).setSyncable(true));
