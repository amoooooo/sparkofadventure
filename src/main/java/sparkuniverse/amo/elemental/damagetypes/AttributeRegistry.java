...
public class AttributeRegistry {
    ...
    public static final RegistryObject<Attribute> FIRE_RESISTANCE = RESISTANCE_ATTRIBUTES.register("fire_resistance", () -> new TypedRangedAttribute("elemental:fire_resistance", 0.0D, 0.0D, 1024D, Apoth.Attributes.FIRE_DAMAGE).setSyncable(true));
    public static final RegistryObject<Attribute> COLD_RESISTANCE = RESISTANCE_ATTRIBUTES.register("cold_resistance", () -> new TypedRangedAttribute("elemental:cold_resistance", 0.0D, 0.0D, 1024D, Apoth.Attributes.COLD_DAMAGE).setSyncable(true));
    public static final RegistryObject<Attribute> LIGHTNING_RESISTANCE = RESISTANCE_ATTRIBUTES.register("lightning_resistance", () -> new TypedRangedAttribute("elemental:lightning_resistance", 0.0D, 0.0D, 1024D, LIGHTNING_DAMAGE).setSyncable(true));
    public static final RegistryObject<Attribute> POISON_RESISTANCE = RESISTANCE_ATTRIBUTES.register("poison_resistance", () -> new TypedRangedAttribute("elemental:poison_resistance", 0.0D, 0.0D, 1024D, POISON_DAMAGE).setSyncable(true));
    public static final RegistryObject<Attribute> ACID_RESISTANCE = RESISTANCE_ATTRIBUTES.register("acid_resistance", () -> new TypedRangedAttribute("elemental:acid_resistance", 0.0D, 0.0D, 1024D, ACID_DAMAGE).setSyncable(true));
    public static final RegistryObject<Attribute> NECROTIC_RESISTANCE = RESISTANCE_ATTRIBUTES.register("necrotic_resistance", () -> new TypedRangedAttribute("elemental:necrotic_resistance", 0.0D, 0.0D, 1024D, NECROTIC_DAMAGE).setSyncable(true));
    public static final RegistryObject<Attribute> RADIANT_RESISTANCE = RESISTANCE_ATTRIBUTES.register("radiant_resistance", () -> new TypedRangedAttribute("elemental:radiant_resistance", 0.0D, 0.0D, 1024D, RADIANT_DAMAGE).setSyncable(true));
    public static final RegistryObject<Attribute> FORCE_RESISTANCE = RESISTANCE_ATTRIBUTES.register("force_resistance", () -> new TypedRangedAttribute("elemental:force_resistance", 0.0D, 0.0D, 1024D, FORCE_DAMAGE).setSyncable(true));
    public static final RegistryObject<Attribute> PSYCHIC_RESISTANCE = RESISTANCE_ATTRIBUTES.register("psychic_resistance", () -> new TypedRangedAttribute("elemental:psychic_resistance", 0.0D, 0.0D, 1024D, PSYCHIC_DAMAGE).setSyncable(true));
    public static final RegistryObject<Attribute> THUNDER_RESISTANCE = RESISTANCE_ATTRIBUTES.register("thunder_resistance", () -> new TypedRangedAttribute("elemental:thunder_resistance", 0.0D, 0.0D, 1024D, THUNDER_DAMAGE).setSyncable(true));
    public static final RegistryObject<Attribute> AIR_RESISTANCE = RESISTANCE_ATTRIBUTES.register("air_resistance", () -> new TypedRangedAttribute("elemental:air_resistance", 0.0D, 0.0D, 1024D, AIR_DAMAGE).setSyncable(true));
    public static final RegistryObject<Attribute> EARTH_RESISTANCE = RESISTANCE_ATTRIBUTES.register("earth_resistance", () -> new TypedRangedAttribute("elemental:earth_resistance", 0.0D, 0.0D, 1024D, EARTH_DAMAGE).setSyncable(true));
    public static final RegistryObject<Attribute> WATER_RESISTANCE = RESISTANCE_ATTRIBUTES.register("water_resistance", () -> new TypedRangedAttribute("elemental:water_resistance", 0.0D, 0.0D, 1024D, WATER_DAMAGE).setSyncable(true));
    public static final RegistryObject<Attribute> NATURE_RESISTANCE = RESISTANCE_ATTRIBUTES.register("nature_resistance", () -> new TypedRangedAttribute("elemental:nature_resistance", 0.0D, 0.0D, 1024D, NATURE_DAMAGE).setSyncable(true));
