        ...
        object.forEach((key, element) -> {
            ...
            for (Map.Entry<String, JsonElement> mob : mobs.entrySet()) {
                ...
                for (Map.Entry<String, JsonElement> damageTypeEntry : damageTypes.entrySet()) {
                    ...
                    if (attribute == null) {
                        Alkahest.LOGGER.error("Invalid Attribute Resistance found!" + damageTypeEntry.getKey());
                        Alkahest.LOGGER.error("Allowed Attributes are: ");
                        ForgeRegistries.ATTRIBUTES.getValues().forEach(it -> Alkahest.LOGGER.error(ForgeRegistries.ATTRIBUTES.getKey(it).toString()));
